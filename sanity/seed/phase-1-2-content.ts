...
export const SEED_PERSON_PROFILE = {
  ...
  professionalSummary:
    "Entry-level Game Developer and SDK Engineer with production experience shipping cross-platform SDKs across 8 game engines (Unity, Unreal, Godot, C++, Java, JS/TS, Defold, Cocos2dx). Experienced in Nakama backend integration (authentication, wallet, leaderboard, RPC), Android/iOS deployment, and building automated build-profile systems for 50+ playable ads. Personal projects have reached 100K+ total downloads. Strong debugging and QA background with CI/CD via GitHub Actions. Open to international remote roles.",
  expertiseAreas: [
    "Languages: C#, C++, Python, JavaScript / TypeScript, Java",
    "Game Engines: Unity 3D, Unreal Engine, Godot, Defold, Cocos2dx",
    "Backend & Infra: Nakama (Auth, Wallet, Leaderboard, RPC), REST APIs, MCP Servers",
    "SDK Platforms: Unity, Unreal, Godot, C++, Java, JS/TS, Defold, Cocos2dx (8 production SDKs)",
    "Mobile & DevOps: Android / iOS Deployment, GitHub Actions (CI/CD), Git, Visual Studio",
    "Tools & Monetization: AdMob, Unity Ads, DOTween, Photon Multiplayer, Unity UI Toolkit, Blender",
    "Methodologies: SDK Development, Cross-Platform Build Systems, QA Testing, Debugging, Backend Integration",
  ],
  profileImageAlt:
...
export const SEED_EXPERIENCE_TOBA = {
  ...
  responsibilities: [
    "Developed, debugged, and published 8 production-ready cross-platform SDKs (Unity, Unreal, Godot, C++, Java, JS/TS, Defold, Cocos2dx) to GitHub and itch.io.",
  ],
  accomplishments: [
    "Developed, debugged, and published 8 production-ready cross-platform SDKs (Unity, Unreal, Godot, C++, Java, JS/TS, Defold, Cocos2dx) to GitHub and itch.io.",
    "Built a custom Playable Ad Toolkit supporting 50+ playables — engineers select a build profile and SDK code is injected automatically via debug symbols; game validators and contracts check builds before shipping.",
    "Shipped playable ads to 10+ advertising platforms using the automated pipeline, reducing manual integration errors.",
    "Integrated Nakama backend systems including authentication flows, wallet, leaderboard, and RPC across multiple live titles.",
    "Resolved critical RPC errors, session handling bugs, and authentication failures in production.",
    "Performed QA testing, bug fixing, and UI fixes on QuizVerse — a flagship title with 100K+ downloads.",
    "Integrated AdMob, Unity Ads, analytics, native sharing, and UI Toolkit into live mobile games (CricketX, ColorCrush2D).",
  ],
